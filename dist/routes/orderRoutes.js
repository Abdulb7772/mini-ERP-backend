...
router.get("/", (0, auth_1.authorize)("admin", "order_manager", "staff"), orderController_1.getOrders);
...
router.put("/:id", (0, auth_1.authorize)("admin", "order_manager", "staff"), orderController_1.updateOrder);
router.post("/create-payment-intent", orderController_1.createPaymentIntent);
router.patch("/:id/status", (0, auth_1.authorize)("admin", "order_manager", "staff"), orderValidator_1.updateOrderStatusValidator, validate_1.validate, orderController_1.updateOrderStatus);
