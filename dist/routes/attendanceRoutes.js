...
router.get("/", (0, auth_1.authorize)("admin", "employee_manager"), attendanceController_1.getAttendanceByDate);
router.get("/my-attendance", attendanceController_1.getMyAttendance); // All authenticated users can view their own attendance
router.get("/history", (0, auth_1.authorize)("admin", "employee_manager"), attendanceController_1.getAttendanceHistory);
