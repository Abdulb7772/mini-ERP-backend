...
// Admin/Staff routes
router.get("/", auth_1.authenticate, (0, auth_1.authorize)("admin", "top_manager", "staff", "customer_manager"), complaintController_1.getAllComplaints);
router.get("/stats", auth_1.authenticate, (0, auth_1.authorize)("admin", "top_manager", "staff", "customer_manager"), complaintController_1.getComplaintStats);
router.get("/:id", auth_1.authenticate, complaintController_1.getComplaintById);
router.put("/:id", auth_1.authenticate, (0, auth_1.authorize)("admin", "top_manager", "staff", "customer_manager"), complaintValidator_1.updateComplaintValidator, validate_1.validate, complaintController_1.updateComplaintStatus);
