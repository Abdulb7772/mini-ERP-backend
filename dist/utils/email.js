...
const sendVerificationEmail = async (email, name, token, password) => {
...
const sendOrderConfirmationEmail = async (email, customerName, orderNumber, items, totalAmount, address) => {
    const transporter = createTransporter();
